 ...
 *   /prime/physics.html:         <script src="../scripts/dm-nav.js" defer></script>
...
(function () {
  ...
  //   /caelestis/prime/wiki/physics.html        → /prime depth 1 → ../
  ...
  var sections = [
    { key: 'physics',   label: 'Physics',  path: 'physics.html'        },
  ...
  var extLinks = [
    ...
    { label: 'Drive Root',           href: 'https://drive.google.com/drive/folders/1dwn2gYoZwHDxwbWYkrVZQVPQZ3HuEtYw' },
  ...
  // Keys are bare ('physics', 'campaign', 'world', 'voyages') — we match
